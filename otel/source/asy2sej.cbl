*{Bench}prg-comment
* asy2sej.cbl
* asy2sej.cbl is generated from C:\Asya_Yedek\liste\YEDEK_OTEL30.11.201762\otel\asy2sej.Psf
*{Bench}end
 IDENTIFICATION              DIVISION.
*{Bench}prgid
 PROGRAM-ID. asy2sej IS INITIAL PROGRAM.
 AUTHOR. ramazan.
 DATE-WRITTEN. 21 Aralýk 2017 Perþembe 17:19:09.
 REMARKS. 
*{Bench}end
...
*{Bench}end
 ...
 01 sendconfirmationlist.
    02 SendConfirmationlist-occ occurs max-kayitresp times.
      03 SendConfirmationlist-keyfield          pic x(250).
      03 SendConfirmationlist-Status            pic x.
      03 SendConfirmationlist-VoucherUrl        pic x(300).
